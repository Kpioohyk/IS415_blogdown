...
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align = "default", fig.cap = "Shiny App About page"}
knitr::include_graphics('/images/storyboard_about.png', error = FALSE)
```
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align = "default", fig.cap = "Shiny App Data page"}
knitr::include_graphics('/images/storyboard_data.png', error = FALSE)
```
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align = "default", fig.cap = "Shiny App EDA page"}
knitr::include_graphics('/images/storyboard_EDA.png', error = FALSE)
```
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align = "default", fig.cap = "Shiny App Cluster(ClustGeo) page"}
knitr::include_graphics('/images/storyboard_clustgeo.png', error = FALSE)
```
```{r echo=FALSE, out.width='50%', fig.show='hold', fig.align = "default", fig.cap = "Shiny App Cluster(SKATER) page"}
