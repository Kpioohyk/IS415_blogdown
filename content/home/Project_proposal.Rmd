...
knitr::include_graphics('/images/storyboard_about.jpg', error = FALSE)
```
```{r echo=FALSE, out.width='100%', fig.show='hold', fig.cap = "Gantts Chart"}
knitr::include_graphics('/images/storyboard_data.jpg', error = FALSE)
```
```{r echo=FALSE, out.width='100%', fig.show='hold', fig.cap = "Gantts Chart"}
knitr::include_graphics('/images/storyboard_EDA.jpg', error = FALSE)
```
```{r echo=FALSE, out.width='100%', fig.show='hold', fig.cap = "Gantts Chart"}
knitr::include_graphics('/images/storyboard_clustgeo.jpg', error = FALSE)
```
```{r echo=FALSE, out.width='100%', fig.show='hold', fig.cap = "Gantts Chart"}
knitr::include_graphics('/images/storyboard_skater.jpg', error = FALSE)
```
